...
doctype_js = {
	...
	"Company": "public/js/peppol_party.js",
	"Supplier": "public/js/peppol_party.js",
}
...
fixtures = [
	{
		...
		"filters": [
			["name", "in", [
				...
				"Sales Invoice-peppol_section_mlr",
				"Sales Invoice-peppol_mlr_status",
				"Sales Invoice-peppol_mlr_description",
